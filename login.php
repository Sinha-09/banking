...
<body style="background: url(images/m1.png);background-size: 100%">
<h1 class="alert alert-success rounded-0"><small class="float-right text-muted" style="font-size: 12pt;"><kbd>Presented by:Shivam Sinha</kbd></small></h1>
<br>
<?php echo $error ?>
<br>
